...
func TestCreateMetafieldDefinition(t *testing.T) {
	...
	httpmock.RegisterResponder("POST",
		fmt.Sprintf("https://%s.myshopline.com/%s/%s/metafield_definition.json", client.GetClient().StoreHandle, client.GetClient().PathPrefix, client.GetClient().ApiVersion),
...
func TestListMetafieldDefinitions(t *testing.T) {
	...
	httpmock.RegisterResponder("GET",
		fmt.Sprintf("https://%s.myshopline.com/%s/%s/metafield_definitions.json?owner_resource=product", client.GetClient().StoreHandle, client.GetClient().PathPrefix, client.GetClient().ApiVersion),
...
func TestListAllMetafieldDefinitions(t *testing.T) {
	...
	apiResp := &metafield2.ListMetafieldDefinitionAPIResp{}
	definitions, err := client.ListAll(client.GetClient(), context.Background(), req, apiResp, func(resp interface{}) []metafield2.MetafieldDefinition {
...
func TestDeleteMetafieldDefinition(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE",
		fmt.Sprintf("https://%s.myshopline.com/%s/%s/metafield_definition.json?id=1", client.GetClient().StoreHandle, client.GetClient().PathPrefix, client.GetClient().ApiVersion),
