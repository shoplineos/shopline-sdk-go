...
type GetAValidBulkTaskAPIReq struct {
	client.BaseAPIRequest
	/*
	   The operation type of the bulk task. Valid values are:
...
func (req *GetAValidBulkTaskAPIReq) GetEndpoint() string {

	return "current_bulk_operation.json"

}

func (req *GetAValidBulkTaskAPIReq) GetMethod() string {
	return "GET"
}

func (req *GetAValidBulkTaskAPIReq) GetQuery() interface{} {
	return req
}

// Verify the api request parameters
func (req *GetAValidBulkTaskAPIReq) Verify() error {

	return nil
}

func (req *GetAValidBulkTaskAPIReq) NewAPIResp() *GetAValidBulkTaskAPIResp {
	return &GetAValidBulkTaskAPIResp{}
}

type GetAValidBulkTaskAPIResp struct {
