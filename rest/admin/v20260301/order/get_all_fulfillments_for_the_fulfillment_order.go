...
type GetAllFulfillmentsForTheFulfillmentOrderAPIReq struct {
...
func (req *GetAllFulfillmentsForTheFulfillmentOrderAPIReq) GetEndpoint() string {

	return fmt.Sprintf("fulfillment_orders/%s/%s/fulfillments.json", req.FulfillmentOrderId, req.OrderId)

}

func (req *GetAllFulfillmentsForTheFulfillmentOrderAPIReq) GetMethod() string {
	return "GET"
}

// Verify the api request parameters
func (req *GetAllFulfillmentsForTheFulfillmentOrderAPIReq) Verify() error {
...
func (req *GetAllFulfillmentsForTheFulfillmentOrderAPIReq) NewAPIResp() *GetAllFulfillmentsForTheFulfillmentOrderAPIResp {
	return &GetAllFulfillmentsForTheFulfillmentOrderAPIResp{}
}

type GetAllFulfillmentsForTheFulfillmentOrderAPIResp struct {
	...
	*/
	Fulfillments []GetAllFulfillmentsForTheFulfillmentOrderAPIRespFulfillment `json:"fulfillments,omitempty" url:"-"`
}

type GetAllFulfillmentsForTheFulfillmentOrderAPIRespFulfillment struct {
	/*
	   Package Product
	   Example: [map[fulfillable_quantity:1 fulfillment_quantity:1 fulfillment_status:"open" grams:10.5 id:"466157049" name:Trade name price:"100.00" price_set:map[presentment_money:map[amount:"100.00" currency_code:"USD"] shop_money:map[amount:"100.00" currency_code:"USD"]] product_id:"343342675" properties:[map[additional:" add-on information " name:" picture " type:"picture" urls:[["https://www.myshopline.com"]] value:"value"]] quantity:1 requires_shipping:true sku:"183423409238904944" tax_lines:[map[name:" item tax " price:"10.00" price_set:map[presentment_money:map[amount:"10.00" currency_code:"USD"] shop_money:map[amount:"10.00" currency_code:"USD"]] rate:"1.00" title:" Product tax "]] taxable:true title:"Draft" total_discount:"0.00" total_discount_set:map[presentment_money:map[amount:"0.00" currency_code:"USD"] shop_money:map[amount:"0.00" currency_code:"USD"]] variant_id:"183423409238904944" variant_title:"Black / Bracelet / Bracelet"" vendor: version:"1"]]
	*/
	LineItems []GetAllFulfillmentsForTheFulfillmentOrderAPIRespLineItem `json:"line_items,omitempty" url:"-"`
...
type GetAllFulfillmentsForTheFulfillmentOrderAPIRespLineItem struct {
	/*
	...
	*/
	Properties []GetAllFulfillmentsForTheFulfillmentOrderAPIRespProperty `json:"properties,omitempty" url:"-"`
	...
	*/
	TaxLines []GetAllFulfillmentsForTheFulfillmentOrderAPIRespTaxLine `json:"tax_lines,omitempty" url:"-"`
...
type GetAllFulfillmentsForTheFulfillmentOrderAPIRespProperty struct {
	/*
...
type GetAllFulfillmentsForTheFulfillmentOrderAPIRespTaxLine struct {
	/*
