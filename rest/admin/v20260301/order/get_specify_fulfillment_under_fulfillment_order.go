...
type GetSpecifyFulfillmentUnderFulfillmentOrderAPIReq struct {
...
func (req *GetSpecifyFulfillmentUnderFulfillmentOrderAPIReq) GetEndpoint() string {

	return fmt.Sprintf("orders/%s/%s/fulfillments.json", req.FulfillmentId, req.OrderId)

}

func (req *GetSpecifyFulfillmentUnderFulfillmentOrderAPIReq) GetMethod() string {
	return "GET"
}

// Verify the api request parameters
func (req *GetSpecifyFulfillmentUnderFulfillmentOrderAPIReq) Verify() error {
...
func (req *GetSpecifyFulfillmentUnderFulfillmentOrderAPIReq) NewAPIResp() *GetSpecifyFulfillmentUnderFulfillmentOrderAPIResp {
	return &GetSpecifyFulfillmentUnderFulfillmentOrderAPIResp{}
}

type GetSpecifyFulfillmentUnderFulfillmentOrderAPIResp struct {
	...
	*/
	Fulfillment GetSpecifyFulfillmentUnderFulfillmentOrderAPIRespFulfillment `json:"fulfillment,omitempty" url:"-"`
}

type GetSpecifyFulfillmentUnderFulfillmentOrderAPIRespLineItem struct {
	/*
	   Product version
	   Example: "1"
	*/
	...
	*/
	TaxLines []GetSpecifyFulfillmentUnderFulfillmentOrderAPIRespTaxLine `json:"tax_lines,omitempty" url:"-"`
	...
	*/
	Properties []GetSpecifyFulfillmentUnderFulfillmentOrderAPIRespProperty `json:"properties,omitempty" url:"-"`
...
type GetSpecifyFulfillmentUnderFulfillmentOrderAPIRespTaxLine struct {
	/*
	   Tax name
	   Example: " item tax "
	*/
...
type GetSpecifyFulfillmentUnderFulfillmentOrderAPIRespProperty struct {
	/*
	   Additional information
...
type GetSpecifyFulfillmentUnderFulfillmentOrderAPIRespFulfillment struct {
	/*
	...
	*/
	LineItems []GetSpecifyFulfillmentUnderFulfillmentOrderAPIRespLineItem `json:"line_items,omitempty" url:"-"`
