...
type GetMetafieldsForAResourceAPIReq struct {
...
func (req *GetMetafieldsForAResourceAPIReq) GetEndpoint() string {

	return fmt.Sprintf("%s/%s/metafields.json", req.Resource, req.OwnerId)

}

func (req *GetMetafieldsForAResourceAPIReq) GetMethod() string {
	return "GET"
}

func (req *GetMetafieldsForAResourceAPIReq) GetQuery() interface{} {
	return req
}

// Verify the api request parameters
func (req *GetMetafieldsForAResourceAPIReq) Verify() error {
...
func (req *GetMetafieldsForAResourceAPIReq) NewAPIResp() *GetMetafieldsForAResourceAPIResp {
	return &GetMetafieldsForAResourceAPIResp{}
}

type GetMetafieldsForAResourceAPIResp struct {
