...
type CreateAMetafieldForTheStoreAPIReq struct {
	...
	*/
	Metafield CreateAMetafieldForTheStoreAPIReqMetafield `json:"metafield,omitempty" url:"-"`
}

type CreateAMetafieldForTheStoreAPIReqMetafield struct {
	/*
...
func (req *CreateAMetafieldForTheStoreAPIReq) GetEndpoint() string {

	return "metafields.json"

}

func (req *CreateAMetafieldForTheStoreAPIReq) GetMethod() string {
	return "POST"
}

func (req *CreateAMetafieldForTheStoreAPIReq) GetData() interface{} {
	return req
}

// Verify the api request parameters
func (req *CreateAMetafieldForTheStoreAPIReq) Verify() error {

	return nil
}

func (req *CreateAMetafieldForTheStoreAPIReq) NewAPIResp() *CreateAMetafieldForTheStoreAPIResp {
	return &CreateAMetafieldForTheStoreAPIResp{}
}

type CreateAMetafieldForTheStoreAPIResp struct {
