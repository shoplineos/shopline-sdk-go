...
type GetStoreMetafieldsAPIReq struct {
...
func (req *GetStoreMetafieldsAPIReq) GetEndpoint() string {

	return "metafields.json"

}

func (req *GetStoreMetafieldsAPIReq) GetMethod() string {
	return "GET"
}

func (req *GetStoreMetafieldsAPIReq) GetQuery() interface{} {
	return req
}

// Verify the api request parameters
func (req *GetStoreMetafieldsAPIReq) Verify() error {

	return nil
}

func (req *GetStoreMetafieldsAPIReq) NewAPIResp() *GetStoreMetafieldsAPIResp {
	return &GetStoreMetafieldsAPIResp{}
}

type GetStoreMetafieldsAPIResp struct {
