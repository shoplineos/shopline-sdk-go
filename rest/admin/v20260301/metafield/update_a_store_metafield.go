...
type UpdateAStoreMetafieldAPIReq struct {
	...
	*/
	Metafield UpdateAStoreMetafieldAPIReqMetafield `json:"metafield,omitempty" url:"-"`
}
...
func (req *UpdateAStoreMetafieldAPIReq) NewAPIResp() *UpdateAStoreMetafieldAPIResp {
	return &UpdateAStoreMetafieldAPIResp{}
}
