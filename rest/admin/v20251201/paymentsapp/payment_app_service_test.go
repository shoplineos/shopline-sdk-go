...
func TestMerchantBindSuccess(t *testing.T) {
	...
	apiReq := &MerchantActivationSuccessfulNotificationAPIReq{
		Handle: "product",
		AppKey: "appkey",
	}

	apiResp := &MerchantActivationSuccessfulNotificationAPIResp{}
...
func TestMerchantPaySuccess(t *testing.T) {
	...
	apiResp := &PaymentSuccessfulNoticeAPIResp{}
	err := cli.Call(context.Background(), apiReq, apiResp)
...
func TestMerchantRefundSuccess(t *testing.T) {
	...
	apiResp := &RefundSuccessfulNotificationAPIResp{}
	err := cli.Call(context.Background(), apiReq, apiResp)
...
func TestMerchantDeviceBindSuccess(t *testing.T) {
	...
	apiReq := &DeviceBindingSuccessNotificationAPIReq{
		ResourceId:       "1",
		BindingReference: "2",
		ConfigData:       "2222",
		Passthrough:      "11",
	...
	apiResp := &DeviceBindingSuccessNotificationAPIResp{}
	err := cli.Call(context.Background(), apiReq, apiResp)
