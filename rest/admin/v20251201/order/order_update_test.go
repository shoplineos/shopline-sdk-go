...
func TestOrderUpdate(t *testing.T) {
	...
	order := UpdateAnOrderAPIReqOrder{
		Id:       "1",
		AreaCode: "8613888888888",
		//FinancialStatus:   "paid",
		//FulfillmentStatus: "fulfilled",
	}

	apiReq := &UpdateAnOrderAPIReq{Id: "1", Order: order}
	apiResp := &UpdateAnOrderAPIResp{}
	...
	if apiResp.Order.Id != expected.Id {
		t.Errorf("Order.Update returned id %s, expected %s", apiResp.Order.Id, expected.Id)
	}
}
