...
import (
	...
	"github.com/shoplineos/shopline-sdk-go/rest/v20251201/paymentsapp"
...
func TestMerchantBindSuccess(t *testing.T) {
	...
	apiReq := &paymentsapp.MerchantActivationSuccessfulNotificationAPIReq{
		Handle: "product",
		AppKey: "appkey",
	}

	apiResp := &paymentsapp.MerchantActivationSuccessfulNotificationAPIResp{}
...
func TestMerchantPaySuccess(t *testing.T) {
	...
	apiReq := &paymentsapp.PaymentSuccessfulNoticeAPIReq{
		ChannelId:                 "1",
		PaymentMethod:             "2",
		Amount:                    "11",
	...
	apiResp := &paymentsapp.PaymentSuccessfulNoticeAPIResp{}
	err := cli.Call(context.Background(), apiReq, apiResp)
...
func TestMerchantRefundSuccess(t *testing.T) {
	...
	apiReq := &paymentsapp.RefundSuccessfulNotificationAPIReq{
		ChannelId:                  "1",
		PaymentMethod:              "2",
		Amount:                     100,
		ChannelOrderTransactionId:  "11",
	...
	apiResp := &paymentsapp.RefundSuccessfulNotificationAPIResp{}
	err := cli.Call(context.Background(), apiReq, apiResp)
...
func TestMerchantDeviceBindSuccess(t *testing.T) {
	...
	apiReq := &paymentsapp.DeviceBindingSuccessNotificationAPIReq{
		ResourceId:       "1",
		BindingReference: "2",
		ConfigData:       "2222",
		Passthrough:      "11",
	...
	apiResp := &paymentsapp.DeviceBindingSuccessNotificationAPIResp{}
	err := cli.Call(context.Background(), apiReq, apiResp)
