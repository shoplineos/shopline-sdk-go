...
func TestCreateMetafieldDefinition(t *testing.T) {
	...
	req := &metafield.CreateMetafieldDefinitionAPIReq{
		MetafieldDefinition: metafield.CreateMetafieldDefinition{
			Access:        metafield.Access{Admin: "MERCHANT_READ_WRITE"},
	...
	apiResp := &metafield.CreateMetafieldDefinitionAPIResp{}
...
func TestUpdateMetafieldDefinition(t *testing.T) {
	...
	req := &metafield.UpdateMetafieldDefinitionAPIReq{
		MetafieldDefinition: metafield.UpdateMetafieldDefinition{
			Access:        metafield.Access{Admin: "MERCHANT_READ_WRITE"},
			Description:   "test desc",
			Key:           "key_test",
			Name:          "name_test",
	...
	apiResp := &metafield.UpdateMetafieldDefinitionAPIResp{}
	err := cli.Call(context.Background(), req, apiResp)
...
func TestGetMetafieldDefinition(t *testing.T) {
	...
	req := &metafield.GetMetafieldDefinitionAPIReq{
		Id: "1",
	}

	//apiResp, err := GetMetafieldDefinitionService().Get(context.Background(), req)
	apiResp := &metafield.GetMetafieldDefinitionAPIResp{}
	err := cli.Call(context.Background(), req, apiResp)
...
func TestListMetafieldDefinitions(t *testing.T) {
	...
	req := &metafield.ListMetafieldDefinitionAPIReq{
		OwnerResource: "product",
	}

	//apiResp, err := GetMetafieldDefinitionService().List(context.Background(), req)
	apiResp := &metafield.ListMetafieldDefinitionAPIResp{}
	err := cli.Call(context.Background(), req, apiResp)
...
func TestListAllMetafieldDefinitions(t *testing.T) {
	...
	apiResp := &metafield.ListMetafieldDefinitionAPIResp{}
	definitions, err := client.ListAll(cli, context.Background(), req, apiResp, func(resp interface{}) []metafield.MetafieldDefinition {
		r := (resp.(*metafield.ListMetafieldDefinitionAPIResp)).Data
...
func TestDeleteMetafieldDefinition(t *testing.T) {
	...
	req := &metafield.DeleteMetafieldDefinitionAPIReq{
		Id: "1",
	}

	//apiResp, err := GetMetafieldDefinitionService().Delete(context.Background(), req)
	apiResp := &metafield.DeleteMetafieldDefinitionAPIResp{}
	err := cli.Call(context.Background(), req, apiResp)
