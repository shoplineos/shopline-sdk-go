...
import (
	...
	"github.com/shoplineos/shopline-sdk-go/rest/v20251201/payment"
...
func TestGetStoreBalance(t *testing.T) {
	...
	apiReq := &payment.BalanceAPIReq{}
	apiResp := &payment.BalanceAPIResp{}
...
func TestListStorePayouts(t *testing.T) {
	...
	apiReq := &payment.GetPayoutsAPIReq{
		Limit: "1",
		//Status:    "SUCCESS",
	...
	apiResp := &payment.GetPayoutsAPIResp{}
	err := cli.Call(context.Background(), apiReq, apiResp)
	if err != nil {
...
func TestListStoreBalanceTransactions(t *testing.T) {
	...
	apiReq := &payment.BalanceTransactionsAPIReq{
		Limit:        "1",
		PayoutStatus: "ok",
	}

	apiResp := &payment.BalanceTransactionsAPIResp{}
	err := cli.Call(context.Background(), apiReq, apiResp)
...
func TestListStoreTransactions(t *testing.T) {
	...
	apiReq := &payment.QueryStoreTransactionRecordsAPIReq{
		Limit:   "1",
		DateMin: "2025-04-30T00:00:00+08:00",
		DateMax: "2025-09-30T00:00:00+08:00",
	}

	apiResp := &payment.QueryStoreTransactionRecordsAPIResp{}
	err := cli.Call(context.Background(), apiReq, apiResp)
