...
type ListOrdersAPIResp struct {
	...
	Orders []ListOrdersAPIRespOrder `json:"orders"`
}
...
// Deprecated
// see OrderService
func ListOrdersAll(c *client.Client, apiReq *ListOrdersAPIReq) ([]ListOrdersAPIRespOrder, error) {
	collector := []ListOrdersAPIRespOrder{}
	// 1. API request
