...
// ListOrderAttributionInfosAPIRequest
...
// Deprecated
// See GetOrderAttributionInBulkAPIReq
type ListOrderAttributionInfosAPIRequest struct {
	client.BaseAPIRequest
	OrderIds []string `json:"orders,omitempty"`
}

func (r *ListOrderAttributionInfosAPIRequest) GetMethod() string {
	return "POST"
}

func (r *ListOrderAttributionInfosAPIRequest) GetQuery() interface{} {
	return r
}

func (r *ListOrderAttributionInfosAPIRequest) Verify() error {
...
func (r *ListOrderAttributionInfosAPIRequest) GetEndpoint() string {
	return "orders/order_attribution_info.json"
}

type ListOrderAttributionInfosAPIResponse struct {
