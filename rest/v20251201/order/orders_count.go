...
// Deprecated
// See GetOrderQuantityAPIReq
type GetOrdersCountAPIRequest struct {
...
func (req *GetOrdersCountAPIRequest) GetMethod() string {
	return "GET"
}

func (req *GetOrdersCountAPIRequest) GetQuery() interface{} {
	return req
}

func (req *GetOrdersCountAPIRequest) Verify() error {
	// Verify the api request params
	return nil
}

func (req *GetOrdersCountAPIRequest) GetEndpoint() string {
	return "orders/count.json"
}

type GetOrdersCountAPIResponse struct {
...
// Deprecated
// see OrderService
func QueryOrdersCount(c *client.Client, req *GetOrdersCountAPIRequest) (*GetOrdersCountAPIResponse, error) {
	// 1. API response data
