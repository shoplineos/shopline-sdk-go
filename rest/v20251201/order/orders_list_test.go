...
func TestOrderListAll(t *testing.T) {
	...
	cases := []struct {
		name                string
		expectedOrders      []ListOrdersAPIRespOrder
	...
	}{
		{
			...
			expectedOrders: []ListOrdersAPIRespOrder{{Id: "1"}, {Id: "2"}, {Id: "3"}, {Id: "4"}},
			expectedErr:    nil,
		},
		{
			...
			expectedOrders: []ListOrdersAPIRespOrder{{Id: "1"}},
			expectedErr:    nil,
		},
		{
...
func TestOrderListWithPagination(t *testing.T) {
	...
	cases := []struct {
		...
		// Expect empty pagination when there is no link header
		{
			`{"orders": [{"id":"1"},{"id":"2"}]}`,
			"",
			[]ListOrdersAPIRespOrder{{Id: "1"}, {Id: "2"}},
