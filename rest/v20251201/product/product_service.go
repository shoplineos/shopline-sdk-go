...
type IProductService interface {
	...
	Count(context.Context, *GetProductCountAPIRequest) (*GetProductCountAPIResponse, error)
...
func (p *ProductService) Count(ctx context.Context, apiReq *GetProductCountAPIRequest) (*GetProductCountAPIResponse, error) {
