...
type AppPlanExpiredEvent struct {
	...
	*/
	SubPackage AppPlanExpiredEventSubPackage `json:"subPackage,omitempty" url:"-"`
	...
	*/
	ExpirationTime int64 `json:"expirationTime,omitempty" url:"-"`
	...
	/*
	   ...
	   Example: 0
	*/
	ExpirationType int `json:"expirationType,omitempty" url:"-"`
