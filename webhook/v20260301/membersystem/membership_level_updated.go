...
type MembershipLevelUpdatedEvent struct {
	...
	*/
	LevelExpiryTime int64 `json:"level_expiry_time,omitempty" url:"-"`

	/*
	   The start time of current level membership of the customer.
	   Example: 1.721750465e+12
	*/
	LevelUpdatedTime int64 `json:"level_updated_time,omitempty" url:"-"`
	...
	*/
	...
	/*
	   ...
	   Example: LEVEL_1
	*/
	LevelNameBefore string `json:"level_name_before,omitempty" url:"-"`

	/*
	   Relevant only when membershipType = LEVEL. Higher the field indicates a higher level.
	   Example: 1
	*/
	LevelOrder int `json:"level_order,omitempty" url:"-"`
	...
	/*
	   ...
	   Example: 2
	*/
	LevelOrderBefore int `json:"level_order_before,omitempty" url:"-"`
	...
	*/
	...
	/*
	   ...
	   Example: UPDATE
	*/
	UpdatedType string `json:"updated_type,omitempty" url:"-"`
	...
	*/
	...
	/*
	   ...
	   Example: MLC6568224957444662294
	*/
	LevelCodeBefore string `json:"level_code_before,omitempty" url:"-"`
}
