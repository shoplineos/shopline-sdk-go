...
type PointsUpdatedEvent struct {
	...
	/*
	   ...
	   Example: 20
	*/
	UpdatedValue int64 `json:"updated_value,omitempty" url:"-"`
	...
	*/
	...
	/*
	   ...
	   Example: 20
	*/
	PointsBalance int64 `json:"points_balance,omitempty" url:"-"`
	...
	*/
	PointsExpiryTime int64 `json:"points_expiry_time,omitempty" url:"-"`
	...
	*/
	UpdatedScene string `json:"updated_scene,omitempty" url:"-"`
}
